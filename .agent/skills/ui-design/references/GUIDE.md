...
This guide provides comprehensive documentation for the **ui-design** skill in the custom-plugin-ux-design plugin.
...
```bash
# Invoke the skill
claude "ui-design - [your task description]"

# Example
claude "ui-design - analyze the current implementation"
```
...
def implement_ui_design(input_data):
    """
    Implement ui-design functionality.
