...
export function BottomTabBar() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 pointer-events-none">
      <div
        aria-hidden="true"
        className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-bg-page via-bg-page/90 to-transparent opacity-80"
        style={{ height: 'calc(3.825rem + var(--safe-area-inset-bottom, 0px))' }}
      />
